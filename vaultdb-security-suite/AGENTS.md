...
**Portas:** na **raiz** de `files (5)` o `docker-compose.yml` usa por defeito **8001 / 6380 / 9091** (API / Redis no host / Prometheus) para não colidir com outro VaultDB em 8000/6379/9090. Nesta pasta (**suite**) as predefinições são **8000 / 6379 / 9090**. O painel na raiz: `http://localhost:8001`.
